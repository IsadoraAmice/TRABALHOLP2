...
import { Container, Form,Table, Row, Col, Button, FloatingLabel, Spinner } from 'react-bootstrap';
...
export default function TabelaEntregadores(props) {
    ...
    return(
        <Container>
            ...
            <p>Quatidade de entregadores cadastrados: {props.listaDeEntregadores.length}</p>
        </Container>
    )
}